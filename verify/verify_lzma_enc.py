...
if __name__ == '__main__' :
    ...
    for in_fname in os.listdir(INPUT_DIR) :
        ...
        if os.path.isfile(in_fname_full) :
            ...
            ret_code1 = run_compress(in_fname_full, cmp_fname_full, level=LEVEL)
            ret_code2 = run_decompress(cmp_fname_full, out_fname_full)
